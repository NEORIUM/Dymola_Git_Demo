...
model First "First example: simple drive train"
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia3(J=Jload, w(fixed=true, start=0)) annotation (Placement(transformation(extent={{82,60},{98,76}})));
...
equation
  ...
  connect(spring.flange_b, inertia3.flange_a)
    annotation (Line(points={{68,0},{76,0},{76,68},{82,68}}));
